  ...
  return (
    <div className="space-y-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
        ...
        >
          <div className="text-center space-y-6 p-8 rounded-2xl bg-card/60 hover:bg-card/90 transition-all duration-500 shadow-lg hover:shadow-2xl border border-primary/10 hover:border-primary/20">
            <div className="w-24 h-24 mx-auto bg-gradient-to-br from-primary/40 to-primary/20 rounded-2xl flex items-center justify-center group-hover:shadow-2xl group-hover:from-primary/60 group-hover:to-primary/30 transition-all duration-500 group-hover:rotate-6">
              <SquareChartGantt className="w-12 h-12 text-primary-foreground group-hover:scale-110 transition-transform duration-300" />
            </div>
            ...
            <div className="flex items-center justify-center text-primary group-hover:text-primary-foreground group-hover:bg-primary/90 rounded-full px-6 py-3 transition-all duration-300 font-semibold text-sm border border-primary/20 group-hover:border-primary">
        ...
        <a
          ...
          className="group transition-all duration-500 hover:scale-105 transform -rotate-1 hover:rotate-0"
        >
          <div className="text-center space-y-6 p-8 rounded-2xl bg-card/60 hover:bg-card/90 transition-all duration-500 shadow-lg hover:shadow-2xl border border-secondary/10 hover:border-secondary/20">
            <div className="w-24 h-24 mx-auto bg-gradient-to-br from-secondary/50 to-secondary/30 rounded-2xl flex items-center justify-center group-hover:shadow-2xl group-hover:from-secondary/70 group-hover:to-secondary/40 transition-all duration-500 group-hover:-rotate-6">
              <Map className="w-12 h-12 text-primary-foreground group-hover:scale-110 transition-transform duration-300" />
            </div>
            <div className="space-y-3">
              <h3 className="text-2xl font-bold font-heading text-foreground group-hover:text-secondary transition-colors duration-300">
            ...
            <div className="flex items-center justify-center text-secondary group-hover:text-primary-foreground group-hover:bg-secondary/90 rounded-full px-6 py-3 transition-all duration-300 font-semibold text-sm border border-secondary/20 group-hover:border-secondary">
        ...
        <a
          ...
          className="group transition-all duration-500 hover:scale-105 transform rotate-1 hover:rotate-0"
        >
          <div className="text-center space-y-6 p-8 rounded-2xl bg-card/60 hover:bg-card/90 transition-all duration-500 shadow-lg hover:shadow-2xl border border-accent/10 hover:border-accent/20">
            <div className="w-24 h-24 mx-auto bg-gradient-to-br from-accent/50 to-accent/30 rounded-2xl flex items-center justify-center group-hover:shadow-2xl group-hover:from-accent/70 group-hover:to-accent/40 transition-all duration-500 group-hover:rotate-6">
              <MapPin className="w-12 h-12 text-primary-foreground group-hover:scale-110 transition-transform duration-300" />
            </div>
            <div className="space-y-3">
              <h3 className="text-2xl font-bold font-heading text-foreground group-hover:text-accent transition-colors duration-300">
                Gazetteer
              </h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="flex items-center justify-center text-accent group-hover:text-primary-foreground group-hover:bg-accent/90 rounded-full px-6 py-3 transition-all duration-300 font-semibold text-sm border border-accent/20 group-hover:border-accent">
