...
export const STEPS: Step[] = [
  {
    id: 'empty',
    label: 'Poster 1 · Map Detail',
    title: 'Panel 1: Start With The W37 Detail',
    body: 'Poster panel 1 establishes the map detail. No annotation object is shown yet.',
  },
  {
    id: 'text',
    label: 'Poster 2 · Textspotting',
    title: 'Panel 2: Mark The Place Name',
    body: 'Poster panel 2 adds one textspotting annotation with value "Coijlang" and its SvgSelector polygon.',
  },
  {
    id: 'icon',
    label: 'Poster 3 · Iconography',
    title: 'Panel 3: Add The Related Symbol',
    body: 'Poster panel 3 keeps the text outline visible, then adds the iconography outline and classification body.',
  },
  {
    id: 'link',
    label: 'Poster 4 · Linking',
    title: 'Panel 4: Connect The Two Evidence Targets',
    body: 'Poster panel 4 builds a linking annotation with motivation "linking" and ordered targets: first iconography, then textspotting.',
  },
  {
    id: 'anchor',
    label: 'Poster 5 · Spatial Anchor',
    title: 'Panel 5: Place The Pixel Anchor',
    body: 'Poster panel 5 updates the linking annotation with a selecting body and PointSelector at x 3251, y 9069.',
  },
  {
    id: 'thesaurus',
    label: 'Poster 6 · Gazetteer Link',
    title: 'Panel 6: Add Place Identity And Coordinates',
    body: 'Poster panel 6 adds identifying and geotagging bodies from the Quilon/Kollam Gazetteer entry, including world coordinates.',
  },
  {
    id: 'future',
    label: 'Poster 7 · Georeference Path',
    title: 'Panel 7: Move Toward IIIF Georeferencing',
    body: 'Poster panel 7 shows how image-space points and world coordinates become control pairs for future IIIF Georeference annotations in Allmaps workflows.',
  },
];
